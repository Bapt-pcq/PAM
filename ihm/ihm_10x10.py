...
class ihm_10x10:
    ...
    def grille10x10(self,timer_enabled):
        ...
        button_clear = tk.Button(etat_partage.root, text="Réinitialiser", command=self.clear10x10,width=15, height=3)
        ...
        # Dimensions de la grille
        grid_width = 10 * 50  # Largeur totale de la grille
        grid_height = 10 * 50  # Hauteur totale de la grille
