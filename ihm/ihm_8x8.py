...
class ihm_8x8:
    ...
    def valider():
        ...
        if not ihm_8x8.check_empty_cells(grid_values) :
    ...
    def verifier():
        ...
        if text_id_message != None:
            canvas.delete(text_id_message)
        if not ihm_8x8.all_unique(grid_values):
        ...
        if not ihm_8x8.all_unique(grid_col):
